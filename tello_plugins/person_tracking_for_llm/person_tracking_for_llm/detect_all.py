...
from sensor_msgs.msg import Image 
    ...
    # for tracking info and key pressed 
...
########################### Callback functions ###########################################################################################   
    ...
    def listener_callback(self, img)->None:
        ...
        if self.process % 4 == 0:
            ...
            self.pg_interface.update_bg_image(self.cv_bridge.cv2_to_imgmsg(self.image_all_detected, "rgb8")) # updating the image on the pygame console
